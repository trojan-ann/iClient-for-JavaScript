 ...
 */
SuperMap.Layer.Unique = SuperMap.Class(SuperMap.Layer.Theme.GeoFeature, {
     ...
     * {String} 用于指定专题要素样式的属性字段名称。此属性字段是要用户数据（feature） attributes 中包含的字段，且字段对应的值的类型必须是数值型。
    ...
    /**
     * Constructor: SuperMap.Layer.Unique
     * 构造函数。
     *
     * (code)
    ...
    CLASS_NAME: "SuperMap.Layer.Unique"
});
