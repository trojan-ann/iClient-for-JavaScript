...
(function () {
	...
	cXMLHttpRequest.prototype.setCredentials = function(withCredentials){
		if("withCredentials" in this._object){
			this._object["withCredentials"]=!!withCredentials;
			return true;
		}
		return false;
	};
    ...
    /**
     * Class: SuperMap.Request.XMLHttpRequest
     * 执行符合（w3C）标准的跨浏览器的XMLHttpRequest对象。
     *  详见 http://code.google.com/p/xmlhttprequest/。
     */
    SuperMap.Request.XMLHttpRequest = cXMLHttpRequest;
})();
