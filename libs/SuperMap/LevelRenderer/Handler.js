 ...
 */
SuperMap.LevelRenderer.Handler = SuperMap.Class(SuperMap.LevelRenderer.Eventful, {
     ...
     *
     */
    initialize: function(root, storage, painter) {
     ...
     *
     */
    _mobildFindFixed: function(event) {
        // touch指尖错觉的尝试偏移量配置
     ...
     *
     */
    _zrenderEventFixed: function(event, isTouch) {
